	...
	// TODO: Add the method:
	  private void sortAndPrint(int numToPrint)
	  {
		...
		/*  for( int i=0; i<numToPrint; i++) {
				if( quakeArray[i].getMagnitude() == quakeArray[i+1].getMagnitude()
						&& quakeArray[i+1].getMagnitude() == quakeArray[i+2].getMagnitude() ) {
					System.out.println(quakeArray[i].getMagnitude());
					break;
				}

			}*/
		  for( int i=0; i<numToPrint && i<quakeArray.length; i++ ) 
